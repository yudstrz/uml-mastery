...
export const umlData: UmlComponent[] = [
    ...
    { id: 'actor_system', type: 'usecase', name: 'Actor (System)', desc: 'Sistem eksternal.', svg: '<svg viewBox="0 0 50 50" fill="none" stroke="#2563EB" stroke-width="2"><rect x="5" y="5" width="40" height="40" rx="4"/><circle cx="25" cy="18" r="5"/><path d="M25 23 L25 35 M15 28 L35 28 M18 42 L25 35 L32 42"/><text x="13" y="12" font-size="6" fill="#2563EB">&lt;&lt;system&gt;&gt;</text></svg>' },
    { id: 'actor_db', type: 'usecase', name: 'Actor (Database)', desc: 'Database eksternal.', svg: '<svg viewBox="0 0 50 50" fill="none" stroke="#2563EB" stroke-width="2"><path d="M10 10 Q25 0 40 10 L40 40 Q25 50 10 40 Z"/><path d="M10 10 Q25 20 40 10"/><text x="14" y="30" font-size="8" fill="#2563EB">DB</text></svg>' },
    { id: 'actor_service', type: 'usecase', name: 'Actor (Service)', desc: 'Web Service/API.', svg: '<svg viewBox="0 0 50 50" fill="none" stroke="#2563EB" stroke-width="2"><circle cx="25" cy="15" r="8"/><path d="M25 23 L25 38 M10 28 L40 28 M15 50 L25 38 L35 50"/><text x="30" y="10" font-size="6" fill="#2563EB">API</text></svg>' },
    { id: 'actor_hardware', type: 'usecase', name: 'Actor (Hardware)', desc: 'Perangkat keras.', svg: '<svg viewBox="0 0 50 50" fill="none" stroke="#2563EB" stroke-width="2"><rect x="10" y="10" width="30" height="30" /><text x="12" y="28" font-size="6" fill="#2563EB">&lt;&lt;hw&gt;&gt;</text></svg>' },
    ...
    { id: 'usecase_abstract', type: 'usecase', name: 'Abstract Use Case', desc: 'Use case abstrak.', svg: '<svg viewBox="0 0 100 50" fill="white" stroke="#2563EB" stroke-width="2"><ellipse cx="50" cy="25" rx="45" ry="20"/><text x="25" y="28" font-style="italic" font-size="10" fill="#2563EB">Abstract</text></svg>' },
    ...
    { id: 'include', type: 'usecase', name: 'Include', desc: 'Wajib.', svg: '<svg viewBox="0 0 80 40" fill="none" stroke="#2563EB" stroke-width="2"><path d="M0 20 L75 20" stroke-dasharray="4,2"/><path d="M75 20 L65 15 M75 20 L65 25"/><text x="15" y="15" font-size="8" fill="#2563EB">&lt;&lt;include&gt;&gt;</text></svg>' },
    { id: 'extend', type: 'usecase', name: 'Extend', desc: 'Opsional.', svg: '<svg viewBox="0 0 80 40" fill="none" stroke="#2563EB" stroke-width="2"><path d="M0 20 L75 20" stroke-dasharray="4,2"/><path d="M75 20 L65 15 M75 20 L65 25"/><text x="15" y="15" font-size="8" fill="#2563EB">&lt;&lt;extend&gt;&gt;</text></svg>' },
    ...
    { id: 'boundary', type: 'usecase', name: 'System Boundary', desc: 'Batasan sistem.', svg: '<svg viewBox="0 0 50 50" fill="none" stroke="#2563EB" stroke-width="2"><rect x="5" y="5" width="40" height="40"/><text x="8" y="15" font-size="6" fill="#2563EB">System</text></svg>' },
    ...
    { id: 'loop_node', type: 'activity', name: 'Loop Node', desc: 'Looping.', svg: '<svg viewBox="0 0 80 40" fill="white" stroke="#2563EB" stroke-width="2"><rect x="5" y="5" width="70" height="30" rx="5"/><path d="M60 30 L70 20 L60 10" fill="none"/><text x="10" y="25" font-size="8" fill="#2563EB">loop</text></svg>' },
    ...
    { id: 'merge', type: 'activity', name: 'Merge', desc: 'Penggabungan.', svg: '<svg viewBox="0 0 50 50" fill="white" stroke="#2563EB" stroke-width="2"><path d="M25 5 L45 25 L25 45 L5 25 Z"/><text x="18" y="30" font-size="8" fill="#2563EB">merge</text></svg>' },
